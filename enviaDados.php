<?php
  ...
  if(isset($_POST['url']) && strlen($_POST['url']) == '0' ) {
    ...
    $para = "miguelsf806@gmail.com."; //SEU E-MAIL
    ...
    $assunto = 'Mensagem do Formulário com inputs Animado';
    ...
    $headers .= "From:  Mensagem do site Burguer Bliss <miguelsf806@gmail.com.\n"; //SEU E-MAIL
    $headers .= "X-Sender:  <miguelsf806@gmail.com.>\n"; //SEU E-MAIL
    $headers .= "X-Mailer: PHP  v".phpversion()."\n";
    $headers .= "X-IP:  ".$_SERVER['REMOTE_ADDR']."\n";
    $headers .= "Return-Path:  <miguelsf806@gmail.com.>\n"; //SEU E-MAIL
